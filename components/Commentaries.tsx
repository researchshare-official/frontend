    ...
    return (
        <Box>
            ...
            >
                <Typography
                    variant="body2"
                    sx={{ color: 'secondary.main', marginRight: '0.5rem' }}
                >
                    {article.Upvote}
                </Typography>
                <ArrowUpward />
    ...
    return (
        <Box>
            ...
            <Box sx={{ display: 'flex', marginBottom: '0.75rem' }}>
                <Box sx={{ display: 'flex', justifyContent: 'space-between' }}>
                    ...
                    <Box>
                        <Typography
                            variant="body1"
                            sx={{ color: 'secondary.main', marginLeft: '1rem' }}
                        >
                            Adina Cazalens
                        </Typography>
                        <Typography
                ...
                <Box>
                    <Typography
                        variant="caption"
                        sx={{ color: 'black', marginLeft: '41rem' }}
                    >
                        07-12-2021
                    </Typography>
                </Box>
            ...
            <Box sx={{ marginBottom: '1.625rem' }}>
                <Typography variant="body2" display="block" width="62.5rem">
                    {' '}
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                    Fusce nec fringilla nulla, id efficitur turpis. Donec sed
                    erat euismod, auctor libero in, mollis risus. Pellentesque
                    feugiat sem quis tortor convallis venenatis. Sed et auctor
                    dui. Sed eu consequat libero. Aenean sit amet convallis
                    nunc, eu feugiat ante. Praesent placerat posuere dolor, nec
                    egestas ex convallis ullamcorper. Phasellus ultricies lectus
                    sem.
                </Typography>
            </Box>
