    ...
    <Box>
      ...
      <Box sx={{ marginBottom: "1.625rem" }}>
        <Typography variant="body2" display="block" width="62.5rem">
          ...
          fringilla nulla, id efficitur turpis. Donec sed erat euismod, auctor
          libero in, mollis risus. Pellentesque feugiat sem quis tortor
          convallis venenatis. Sed et auctor dui. Sed eu consequat libero.
          Aenean sit amet convallis nunc, eu feugiat ante. Praesent placerat
          posuere dolor, nec egestas ex convallis ullamcorper. Phasellus
          ultricies lectus sem.
        </Typography>
      </Box>
