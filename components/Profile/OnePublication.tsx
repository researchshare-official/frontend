    ...
    return (
        <Box sx={{ display: 'flex', flexGrow: 1 }} {...props}>
            ...
            <Box m={2}>
                ...
                <Typography variant="subtitle1" sx={{ color: 'secondary.main' }}> Adrien Michaud, Adina Cazalens, Alexandre Monnier, Maugan Verdier, Lorenzo Carrascosa </Typography>
            ...
            <Typography sx={{ whiteSpace: "nowrap" }}>06-07-2021</Typography>
        </Box>
    );
};
